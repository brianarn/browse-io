  ...
  if (opts.forward) {
    ...
    if (opts.forward === true) {
      ...
      Serial.detect.call(this, function (path) {
        Serial.connect.call(this, path, parent._forwardReady)
      });
    } else {
...
BrowseIO.prototype._forwardReady = function (err, type, io) {
  ...
  */
  ...
  ['connect', 'ready'].forEach(function (type) {
    io.once(type, function () {
      this.debug('Forward IO event: ', type);
      if (io.isConnected && io.isReady) {
        this.forwardReady = true;
